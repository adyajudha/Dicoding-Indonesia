...
suspend fun sum(valueA: Int, valueB: Int): Int {
    delay(3000L)
    val tambah = (valueA + valueB)
    return tambah
    //saya menambahkan variabel "tambah" agar valueA + valueB bisa dipanggil
}
...
suspend fun multiple(valueA: Int, valueB: Int): Int {
    delay(2000L)
    val kali = (valueA * valueB)
    return kali
    //saya menambahkan variabel "kali" agar valueA * valueB bisa diapnggil
}
