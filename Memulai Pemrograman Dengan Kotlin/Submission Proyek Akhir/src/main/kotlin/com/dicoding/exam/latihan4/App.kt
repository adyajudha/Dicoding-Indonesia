 ...
 *
 */
fun vehicle() : Map<String, String> = mapOf("type" to "motorcycle", "maxSpeed" to "230Km/s", "maxTank" to "100Ltr")
//kata kunci "mapOf" diletakkan setelah param "Map" untuk menambahkan key dan value-nya
